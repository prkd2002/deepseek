  ...
  return (
    ...
    >
      <div>
        ...
        <div
          className={`text-white/25 text-sm mt-8 ${expand ? "block" : "hidd"}`}
        >
      ...
      <div>
        <div
          className={`flex items-center cursor-pointer group relative ${
            expand
              ? "gap-1 text-white/80 text-sm p-2.5 border border-primary rounded-lg"
        ...
        >
          ...
          >
            <div className="relative w-max bg-black text-white text-sm p-8 rounded-lg shadow-lg">
